					...
					<form id="registerForm" action="<%=path%>/user_regist.action"
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUsername(this)"></input>
								...
								<tr>
									...
									<td><input type="text" id="name" name="name" class="text"
										maxlength="20" onblur="checkName(this)"></input> <span
										id="name_span"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>身份证号:</th>
									<td><input type="text" id="identification"
										name="identification" class="text" maxlength="18"
										onblur="checkIdentification(this)"></input> <span
										id="identification_span"></span></td>
								</tr>
								<tr>
									<th>性别:</th>
								...
								<tr>
									...
									<td><input type="text" id="phone" name="phone"
										class="text" onblur="checkPhone(this)"></input> <span
										id="phone_span"></span></td>
								</tr>
								...
								<tr>
									<th>&nbsp;</th>
									<td><input type="submit" class="submit" value="同意以下协议并注册"></input>
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="<%=path%>/user_loginPage.action">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
