...
public class MailUitls {
    ...
    public static String myEmailAccount = "Xstephen_416@163.com";
    public static String myEmailPassword = "caoxipeng0416";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String name, String code) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "4396购物商城", "UTF-8"));
